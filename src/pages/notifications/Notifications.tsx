...
const NotificationPage: React.FC<NotificationProps> = ({ children }) => {
    ...
    return (
        <React.Fragment>
            ...
            <Container fluid className="p-0">
                ...
                <Row>
                    <Col lg="8">
                        {listMode ? <Notifications updateListMode={updateListMode} setSelectedRow={setSelectedRow} /> : <NotificationForm updateListMode={updateListMode} notification={notification} />}
                    </Col>
                    <Col lg="4">
