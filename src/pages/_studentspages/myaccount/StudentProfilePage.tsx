...
// import TeacherMyAccountProfile from '../../components/teacher/teacherMyAccount/TeacherMyAccountProfile';
// import TeacherMyAccountSideProfile from '../../components/teacher/teacherMyAccount/TeacherMyAccountSideProfile';
// import TeacherMyAccountForm from '../../components/teacher/teacherMyAccount/TeacherMyAccountForm';

import StudentMyAccountProfile from '../../../components/students/studentMyAccount/StudentMyAccountProfile';
import StudentMyAccountSideProfile from '../../../components/students/studentMyAccount/StudentMyAccountSideProfile';
import StudentMyAccountForm from '../../../components/students/studentMyAccount/StudentMyAccountForm';
...
const StudentProfilePage: React.FC<TeacherProps> = ({ children }) => {
    ...
    const setSelectedRow = (mode: StudentModel | undefined) => {
        setStudent(mode);
    };
    ...
    return (
        <React.Fragment>
            ...
            <Container fluid className="p-0">
                ...
                {listMode ? (<Row className='flex-lg-row-reverse'>
                    <Col lg="8">
                        <StudentMyAccountProfile
                    ...
                    <Col lg="4">
                        <StudentMyAccountSideProfile updateListMode={updateListMode} />
                    </Col>
                </Row>) : <StudentMyAccountForm updateListMode={updateListMode} />}
