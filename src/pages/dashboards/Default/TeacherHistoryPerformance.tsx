...
interface TeachersProps {
    // listMode?: boolean;
    TeacherData: (mode: boolean) => void;
}

const TeacherHistoryPerformancePieChart: React.FC<TeachersProps> = ({ TeacherData }) => {
    const palette = usePalette();

    const TeacherPerformance = async (data: any) => {
        TeacherData(true);
    }
    const data = {
...
export default TeacherHistoryPerformancePieChart;
