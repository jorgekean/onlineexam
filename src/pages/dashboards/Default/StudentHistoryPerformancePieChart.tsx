...
const StudentHistoryPerformancePieChart: React.FC<StudentsProps> = ({ StudentData }) => {
    const palette = usePalette();

    const studentPerformance = async (data: any) => {
        StudentData(true);
    }
    const data = {
                ...
                <div className="card-actions float-end">
                    <Dropdown align="end" className="d-flex justify-content-start gap-1">
                        <div className='d-flex gap-1'>
                            <Button onClick={(e) => studentPerformance(e)}><FontAwesomeIcon icon={faList} /> List</Button>
                        </div>
...
export default StudentHistoryPerformancePieChart;
