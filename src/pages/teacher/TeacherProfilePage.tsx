...
const TeacherProfilePage: React.FC<TeacherProps> = ({ children }) => {
        ...
        <React.Fragment>
            ...
            <Container fluid className="p-0">
                ...
                {listMode ? (<Row className='flex-lg-row-reverse'>
                    ...
                    <Col lg="4">
                        <TeacherMyAccountSideProfile updateListMode={updateListMode} />
                    </Col>
                </Row>) : <TeacherMyAccountForm updateListMode={updateListMode} />}
