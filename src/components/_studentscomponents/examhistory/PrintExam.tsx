...
const PrintExam: React.FC<ExamResultPageProps> = ({ children }) => {
    const { id } = useParams();
        ...
        const fetchData = async () => {
            if (id) {
                ...
                if (data) {
                    ...
                    const updatedData: PrintExamResultsModel = { ...data, questions: updatedQuestions, accuracyRatio: 58.33 };// mock accurayRation for now since we are using mock sample data
    ...
    const sampleData = [
        ...
        },
        {
            ...
            correctAnswer: 0,
            userAnswer: 0, // You can leave userAnswer as -1 for new questions
        },
        {
            questionNumber: 9,
