...
const StudentMyAccountForm: React.FC<StudentProps> = ({ updateListMode, student }) => {
            ...
            <Card.Header>
                <div className='d-flex justify-content-between align-items-center'>
                    ...
                    <div className='d-flex gap-1'>
                        <Button onClick={() => updateListMode(true)}><FontAwesomeIcon icon={faArrowLeft} /> Back</Button>
                    </div>
                </div>
            </Card.Header>
            <Card.Body>
                <Form onSubmit={handleFormSubmit}>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Select
                            ...
                            isSearchable
                            value={subjectOptions.find((option) => option.value === formState.studentSubject)}
                            onChange={(selectedOption) => {
                                if (selectedOption) {
                                    setFormState((prevState) => ({
                                        ...prevState,
                                        studentSubject: selectedOption.value,
                                    }));
                                } else {
                                    setFormState((prevState) => ({
                                        ...prevState,
...
export default StudentMyAccountForm
