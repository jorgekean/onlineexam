...
const ExamStatistics
    : React.FC<ExamStatisticProps> = ({ UpdateExamStatisticsView }) => {
    
const ViewExamStatistic = async () => {
        UpdateExamStatisticsView(true)// show create/edit form 
    }
