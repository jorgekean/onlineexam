      ...
      <Table striped className="my-0">
        <thead>
          <tr>
            ...
            <th>Status</th>
            {user && user.role !== "teacher" && <th className="d-none d-md-table-cell">Teacher</th>}
        ...
        <tbody>
          <tr>
            ...
            {user && user.role !== "teacher" && <td className="d-none d-md-table-cell">Carl Jenkins</td>}
          </tr>
          <tr>
            ...
            {user && user.role !== "teacher" && <td className="d-none d-md-table-cell">Bertha Martin</td>}
          </tr>
          <tr>
            ...
            {user && user.role !== "teacher" && <td className="d-none d-md-table-cell">Stacie Hall</td>}
          </tr>
          <tr>
            <td>Project Nitro</td>
            <td className="d-none d-xl-table-cell">01/01/2021</td>
          ...
          <tr>
            ...
            {user && user.role !== "teacher" && <td className="d-none d-md-table-cell">Ashley Briggs</td>}
          </tr>
          <tr>
...
export default TeacherLatestExam;
